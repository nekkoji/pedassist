...
export default function ArmOrientationScreen({ navigation }) {
    
    const handleNextStep = () => {
        navigation.navigate('Tie Tourniquet');
    };
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.headerContainer}>
                    <Text style={styles.headerText}>Ensure Proper Arm Orientation</Text>
                </View>
